package com.hollysmart.navigationmodule.view;
...
import com.hollysmart.navigationmodule.adapter.ViewPagerAdapter;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, R.layout.navigation_module_container_layout, null);
...
//        }
    ...
    private void addTabItemView(final int position) {
        View itemView = View.inflate(getContext(), R.layout.navigation_module_navigation_tab_layout, null);
        ...
        itemView.setTag(R.id.navigation_module_tag_view_position, position);
